		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light" style="height: 150px;">
			<div class="container-fluid">
				<a class="navbar-brand" href="${pageContext.request.contextPath}">
					<img src="${pageContext.request.contextPath }/resources/images/로고2.png" style=" width:450px;  height:120px;" alt="" />
				</a>
				...
				<div class="collapse navbar-collapse" id="navbars-host">
                    ...
                    <c:if test="${!empty member}">
                       ...
                       <span>
                       		<a href="${pageContext.request.contextPath}/member/memberView.do?userId=${member.userId}" title="마이 페이지 이동"><strong>${member.nickName}</strong></a> 님, 안녕하세요
                       	</span>
                        </li>&nbsp;&nbsp;&nbsp;
