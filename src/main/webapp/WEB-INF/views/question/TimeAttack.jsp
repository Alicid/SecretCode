...
<c:import url="../common/header.jsp" />
    <div id="a-three">
      ...
      <div id="advice">
        ...
        <ul class="ul">
          ...
          <li><b>제한시간은 3분입니다.</b> 시간을 주시하십시오.</li>
          <li>모든 질문에 답하십시오.</li>
        </ul>
      </div>
    </div>
      ...
      <div style="top: 96%; position: absolute;left: 36%;">
      	<p id="timer"></p>
      </div>
    ...
    $(function(){
      ...
      $('#start_btn').click(function(){
    	  $(this).hide();
    	  $('#next_btn').show();
        $('#quiz_area').html('<div id="realQuiz" style="text-align: center;margin: auto;margin-top: 148px;font-size: 75px;">시작합니다!<br><font size=5>제한시간은 3분입니다!</div>');
			...
			if (SetTime < 0) {			// 시간이 종료 되었으면..
				clearInterval(tid);		// 타이머 해제
        		 ...
        		 var categoryRange = $('#main-title3').text();
        		  ...
        		  sessionStorage.setItem('unitNum',$unitNum);
        		 ...
        		 // console.log('채점결과');
        		  ...
        		  location.href = "${pageContext.request.contextPath}/question/timeAttackResult.do";
			}
